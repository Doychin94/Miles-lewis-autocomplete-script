 ...
 * @returns {Void}
 */
function assignIdsToElements(parent) {
	const results = [];

	const elements = parent.find('h1, h2, h3, h4, h5, h6, ul > li, p').filter(function() {
		return $(this).is('ul > li') || $(this).closest('li').length === 0;
	});

	elements.each((index, element) => {
		$(element).attr('id', `intro-${index}`);
		// results.push(setData('Miscellaneous Antiquarian Literature &C', `https://www.mileslewis.net/55-miscellaneous-antiquarian-literature-c#intro-${index}`, $(element).text()))
	});
}
 ...
 * @returns {Object}
 */
function setData(page,href,text){
	return {
		page,
		href,
		bullet: text,
...
function scrollToElementById() {
	...
	$targetElement.css('background', '#ffff006b');

	if ($targetElement.length) {
		$('html, body').animate({
			scrollTop: $targetElement.offset().top - 40
		}, 500); // 500ms scroll time
	}
}
 ...
 */
$(window).on('load', () => {
	const targets = ['.fe-667538ab1fa89a57aa0cfd0f', '.fe-667539968ddf964141dcbf70', '.fe-66753a236f084f49cdc173f6', '.fe-66753a93d68dd80d70a56da6', '.fe-66753b4ca6109a645659cd5e', '.fe-66753c93ba50812d16d1076b', '.fe-66753eaf9e639f5e72c4ca5f', '.fe-667541df27782f7ee86ab898', '.fe-667542de94c7096f19a62005', '.fe-66754381070c4a4dc5f986f6', '.fe-6675442f070c4a4dc5f9ad20', '.fe-66754cb288a8835fb10ab564', '.fe-66754d83b07d236bca1acd3e', '.fe-66754e9da6109a64565d3787', '.fe-66754f9e1fa89a57aa111862', '.fe-6676234ad8bb3748a528acfa', '.fe-6676262e36902344bd8602c5', '.fe-667626ad986ff8286b7387f6', '.fe-66762780e1dc2d4f051c5300', '.fe-667627fbb3eb8368fd564f22', '.fe-66767568f8d53c2d1a53c3cd', '.fe-667676199c05f96c44b2ab1f', '.fe-667676ec926f11354266dcb3', '.fe-667677aca870e70b41e2d4d2', '.fe-66767a82d1494f54b5e1de66', '.fe-66767acd03a4f15ba249504c', '.fe-66767b33d1494f54b5e1f76c', '.fe-66767d0503a4f15ba249a15e', '.fe-66767dfe26bde82046cf0e4e', '.fe-66767ed3c719c9745c21f0cf', '.fe-66767eae3628ed0aaa47e961', '.fe-66767f42f9e18b665e050954', '.fe-66767f8a1b33582648245b15', '.fe-667685390cef814bf9bfc768', '.fe-667680a5b3eb8368fd6487f1', '.fe-667685b836902344bd957ffb', '.fe-66768748d497a70b942cc6d3', '.fe-667689404e6f776930a96683', '.fe-66768bd51b33582648261128', '.fe-66768fbab7532624e54c4955', '.fe-6676908a4f07162c0d72d8cd', '.fe-66769123986ff8286b843cc1', '.fe-667691b9e74f5143941c0e6b', '.fe-6676922321362e6c83896c9b', '.fe-667692612a0dfe0ec38ca46e', '.fe-667692d878da9f129e1e4243', '.fe-66769323407be66f5c21184c', '.fe-6676938878da9f129e1e59c2', '.fe-6676949d85dba077abec804f', '.fe-6676953c7ffd193fdaa2ba60', '.fe-667695e2c719c9745c24f89f', '.fe-667697407cfbe72c9a33e8ff', '.fe-6676982ba7e12c13d3aa5fbb', '.fe-6676986aefa37528c0630332', '.fe-667698e3409eb81ea9fdbe19'];

	targets.forEach((className => {
		const $targetParent = $(className);
		if ($targetParent.length === 0) {
			return;
		}

		assignIdsToElements($targetParent);
	}))

	scrollToElementById();
});

initAutocomplete($searchWrappers);
